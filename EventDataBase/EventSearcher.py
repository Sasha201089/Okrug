...
def write_new_events():
  ...
  response = client.responses.create(
    model="gpt-5-nano",
    input='''Проанализируй эти веб страницы: https://it-event-hub.ru/, https://developers.sber.ru/kak-v-sbere/events, https://www.directline.pro/digital-events/it/spb/ и напиши информацию только о мероприятиях, проходящих
